...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (rainbow-delimiters geiser anakondo flycheck-clj-kondo parinfer markdown-preview-mode flx-ido shell-pop adoc-mode ido-vertical-mode smex ido-completing-read+ ## all-the-icons spaceline spaceline-config browse-kill-ring cider terraform-mode emamux javascript-eslint web-mode lsp-java go-mode projectile-rails dumb-jump inf-clojure nim-mode neotree magit markdown-mode golden-ratio zenburn-theme clj-refactor company paredit exec-path-from-shell)))
